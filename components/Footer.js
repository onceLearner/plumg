                ...
                <div className="socials flex flex-col  space-y-4 md:mt-4  py-4  ">
                    ...
                    <div className="flex flex-wrap  space-x-5 items-center  justify-evenly  ">
                        <div className="p-3 bg-white shadow-lg rounded-full">
                            <svg className="w-5 h-5" xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-facebook" viewBox="0 0 16 16">
                        ...
                        <div className="p-3 bg-white shadow-lg rounded-full">
                            <svg className=" w-5 h-5" xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-youtube" viewBox="0 0 16 16">
                        ...
                        <div className="p-3 bg-white shadow-lg rounded-full transition duration-200 ease-in  cursor-pointer  hover:border-black border border-white">
                            <svg className="w-5 h-5" xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-twitter" viewBox="0 0 16 16">
